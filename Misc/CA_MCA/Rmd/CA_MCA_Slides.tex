...
\toprule
  & CN & Dementia & MCI\\
\midrule
ADV & 0.006 & -0.004 & -0.002\\
B & 0.007 & 0.004 & -0.010\\
B+ & 0.003 & -0.001 & -0.001\\
HS & -0.007 & 0.008 & 0.000\\
HS+ & -0.007 & -0.004 & 0.013\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{\label{tab:edu_dx_chi2_colconstraints}Column constraints (inverse row margins)}
\centering
\begin{tabular}{>{\em}lrrr}
\toprule
  & CN & Dementia & MCI\\
